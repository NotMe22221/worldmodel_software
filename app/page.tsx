...
export default function Home() {
  ...
  if (view === "landing") return (
    <main className="landing-shell">
      <header className="landing-nav"><div className="brand"><Logo /><span>WorldModel</span><b>ALPHA</b></div><div><button onClick={() => window.location.assign("/trust")}>Trust center</button><button onClick={() => setView("twin")}>View demo twin</button><button onClick={() => window.location.assign("/dashboard")}>Open workspace</button><button className="primary" data-testid="start-simulation" onClick={() => setView("setup")}>Start a simulation</button></div></header>
      ...
      <nav className="landing-legal" aria-label="Company information"><a href="/security">Security</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/support">Support</a></nav>
    </main>
  );
