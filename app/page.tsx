...
export default function Home() {
  ...
  if (view === "landing") return (
    <main className="landing-shell">
      <header className="landing-nav"><div className="brand"><Logo /><span>WorldModel</span><b>ALPHA</b></div><div><button onClick={() => setView("twin")}>View demo twin</button><button className="primary" data-testid="start-simulation" onClick={() => setView("setup")}>Start a simulation</button></div></header>
