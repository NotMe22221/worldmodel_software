...
export default function Home() {
  return <main className="warm-landing">
    ...
    <section className="warm-step-grid" id="platform">
      <article><header><i>1</i><div><b>Model your world</b><span>Connect your services and define normal behavior.</span></div></header><div className="mini-scene mini-topology"><span>◎</span><span>‹/›</span><span>▱</span><span>▣</span><span>⚙</span><svg viewBox="0 0 260 120" aria-hidden="true"><path d="M44 32 H110 L155 24 M110 32 L92 92 M155 24 V80 H213" /></svg></div><footer>⌘ Topology & contracts</footer></article>
      <article><header><i>2</i><div><b>Simulate the unexpected</b><span>Inject failures that mirror real production incidents.</span></div></header><div className="mini-scene mini-faults"><div><p>› Latency spike</p><p>› DB connection drops</p><p>› Payment gateway timeout</p><p>› Queue backlog</p></div><i>!</i></div><footer>ϟ Fault library</footer></article>
      <article><header><i>3</i><div><b>AI repairs & verifies</b><span>Agents propose fixes and verify them in simulation.</span></div></header><div className="mini-scene mini-repair"><div><i /><i /><i /><i /></div><span>Apply fix&nbsp; ✓</span></div><footer>✦ Repair tournament</footer></article>
      <article><header><i>4</i><div><b>Ship with confidence</b><span>Continuously test, learn, and prevent regressions.</span></div></header><div className="mini-scene mini-chart"><svg viewBox="0 0 260 120" aria-hidden="true"><path d="M8 102 C35 96 39 55 61 69 S91 87 111 45 S143 80 164 47 S195 65 211 31 S238 24 252 8" /><line x1="8" y1="102" x2="252" y2="102" /></svg><i>✓</i></div><footer>♢ Continuous confidence</footer></article>
    </section>
